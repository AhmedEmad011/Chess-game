...
public final class King extends Piece {
    ...
    public Square getKingSquare(Player player , ClassicChessGame chessGame) {
        for (int fileIndex = 0; fileIndex < BoardFile.values().length; fileIndex++) {
            for (int rankIndex = 0; rankIndex < BoardRank.values().length; rankIndex++) {
