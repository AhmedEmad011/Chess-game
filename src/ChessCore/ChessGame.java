...
public abstract class ChessGame {
    ...
    Stack<GameStateMemento> gameStateStack = new Stack<>();
    ...
    public boolean makeMove(Move move) throws CloneNotSupportedException {
        ...
        GameStateMemento gameState = new GameStateMemento(whoseTurn,board ,canWhiteCastleKingSide, canWhiteCastleQueenSide, canBlackCastleKingSide, canBlackCastleQueenSide);
...
//                System.out.print(board.getPieceAtSquare(s));
//
//            }
//
//        }
       ...
       // GameStateMemento gameState = new GameStateMemento(whoseTurn,board);
        gameStateStack.push(gameState);
    ...
    public void undoMove() {
        ...
        if (!gameStateStack.isEmpty()) {
             ...
             GameStateMemento gameState =gameStateStack.pop();
             board = gameState.getBoard();
             whoseTurn = gameState.getCurrPlayer();
             canBlackCastleKingSide=gameState.isCanBlackCastleKingSide;
             canBlackCastleQueenSide=gameState.isCanBlackCastleQueenSide;
             canWhiteCastleKingSide=gameState.isCanWhiteCastleKingSide;
             canWhiteCastleQueenSide= gameState.isCanWhiteCastleQueenSide;
